				...
				<div class="pt-7 bg-neutral-100">
					<div class="pl-10 py-20 pt-10">
						<div class="px-10 pr-10 ">
							<div className="font-medium text-4xl mt-6 mb-2 uppercase text-center">
								Bài viết nổi bật
							</div>
							<h4 class="font-roboto font-light text-md mb-8 text-center">
								Các chủ đề ẩm thực{" "}
								<em class="text-red text-bold">HOT nhất</em> gần
								đây
							</h4>

							<ul className="text-black-800 flex text-center justify-center">
								<li className="text-[#D4A373] font-poppins font-normal cursor-pointer text-[18px] hover:underline decoration-900 underline-offset-8 decoration-2  mr-10  ">
									Tất cả
								</li>
					...
					<div class="px-20 py-5 pb-20">
						...
						<h4 class="font-roboto font-light text-md text-center mb-5">
							Các chủ đề ẩm thực{" "}
							<em class="text-red text-bold">mới nhất</em> gần đây
						</h4>
