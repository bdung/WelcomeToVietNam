...
const filters = [
	{
		...
		options: [
			...
			{
				value: "Phiêu lưu và thám hiểm",
				label: "Phiêu lưu và thám hiểm",
				checked: false,
			},
	...
	},
	{
		...
		options: [
			...
			{
				value: "Lệ hội và sự kiện",
				label: "Lễ hội và sự kiện",
				checked: false,
			},
	...
	},
	{
		...
		options: [
			...
			{
				value: "Lễ hội và sự kiện",
				label: "Lễ hội và sự kiện",
				checked: false,
			},
			{
				value: "Hướng dẫn ẩm thực",
				label: "Hướng dẫn ẩm thực",
				checked: true,
			},
		],
	},
		...
		<React.Fragment>
			<div>
				<div
					...
					className=" text-white font-poppins h-[350px] flex justify-evenly items-center pt-5 "
				>
					<div className="">
