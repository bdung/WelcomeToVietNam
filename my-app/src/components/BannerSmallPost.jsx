    ...
    return (
        <React.Fragment>
            <div className="max-w-[240px] mx-auto rounded-xl shadow-md overflow-hidden md:max-w-2xl relative">
                <div className="md:flex flex-col h-100" style={{ backgroundImage: `url(${postInfo.url})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    <div className='m-2'>
                    <div className="p-3 bg-black bg-opacity-40 rounded-lg mt-56">
                        <div className="flex flex-row justify-between ">
                            <div className=" md:text-lg text-white italic " style ={{fontSize:'12px'}}> Ngày đăng {postInfo.uploadTime}</div>
                            <div className=" md:text-lg text-white italic " style ={{fontSize:'12px'}}>{postInfo.timeForRead}</div>
                        </div>
                        <div className="mt-1 text-lg leading-tight font-medium text-white hover:underline text-ellipsis overflow-hidden roboto-bold text-wrap-2-line">{postInfo.title}</div>
                        <div className="mt-5 flex flex-row justify-between align-middle">
                            ...
                            <div className="flex flex-row">
                                <p className="text-white text-sm hover:font-bold ">Xem thêm</p>
