...
function Navbar() {
  ...
  return (
   <nav className="w-full flex py-6 justify-between items-center navbar bg-black opacity-40">
...
export default Navbar;
 ...
 /* {navLinks.map((nav, index) => (
       <li
         key={nav.id}
         className={`font-poppins font-normal cursor-pointer text-[14px] hover:underline decoration-blue-900 underline-offset-8 decoration-4 ${
