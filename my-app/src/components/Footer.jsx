		...
		<div className="bg-neutral-900 flex justify-around  text-white h-80 pt-16  font-poppins">
			<div>
				...
				<ul className="font-light ">
					<li className="mb-3">
						Kênh thông tin:{" "}
						<a href="#">
							<i>info@welcometovietnam.com</i>
						</a>
					</li>
					<li className="mb-3">
						Kênh hỗ trợ khách hàng:{" "}
						<a href="#" className="text-bold">
							<i>support@welcometovietnam.com</i>
						</a>{" "}
					</li>
					<li className="mb-3">
						Kênh liên lạc:{" "}
						<a href="#">
							<i>contact@welcometovietnam.com</i>
						</a>{" "}
					</li>
			...
			<div>
				...
				<div className="relative inline-block">
					...
					<input
						className="rounded-2xl border-solid boder-2 border-white-8 w-60 h-10 text-black pl-10 text-sm"
						type="text"
